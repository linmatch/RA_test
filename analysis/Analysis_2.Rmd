...
5. Comparison of change in Flavor Perception by different group("CNV_group", "sAA_After_Group" etc.)
...
# More to do:
## Statistical test:
1. ANOVA test: Test if there is significant difference of certain flavor perception for 2 sample gums at certain time point.
2. ANOVA test: Test if there is significant difference of certain flavor perception for different gene copy numbers group (low vs. high) with certain sample gums at certain time point.
